...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS `savings_goals` (
        ...
        `emoji` VARCHAR(50) DEFAULT 'target',
    ...
    if ($count == 0) {
        $categories = [
            // === EXPENSE CATEGORIES ===
            // Rumah Tangga
            ['Rumah Tangga', 'expense', null, 'home', '#818cf8', 1],
            ['Listrik', 'expense', 'Rumah Tangga', 'zap', '#818cf8', 1],
            ['Air (PDAM)', 'expense', 'Rumah Tangga', 'droplets', '#818cf8', 2],
            ['Internet', 'expense', 'Rumah Tangga', 'wifi', '#818cf8', 3],
            ['Sewa/Cicilan', 'expense', 'Rumah Tangga', 'key', '#818cf8', 4],
            ['Kebersihan', 'expense', 'Rumah Tangga', 'trash-2', '#818cf8', 5],
            ['Perbaikan', 'expense', 'Rumah Tangga', 'wrench', '#818cf8', 6],
            ['Peralatan RT', 'expense', 'Rumah Tangga', 'hammer', '#818cf8', 7],

            // Anak
            ['Anak', 'expense', null, 'baby', '#f472b6', 2],
            ...
            ['Gas/LPG', 'expense', 'Dapur', 'flame', '#fbbf24', 6],
            ...
            // Jajan
            ['Jajan', 'expense', null, 'pizza', '#ff6b6b', 5],
            ['Kopi/Cafe', 'expense', 'Jajan', 'coffee', '#ff6b6b', 1],
            ['Street Food', 'expense', 'Jajan', 'soup', '#ff6b6b', 2],
            ['Restaurant', 'expense', 'Jajan', 'utensils', '#ff6b6b', 3],
            ['Boba/Minuman', 'expense', 'Jajan', 'glass-water', '#ff6b6b', 4],
            ['Snack', 'expense', 'Jajan', 'cookie', '#ff6b6b', 5],

            // Kesehatan
            ['Kesehatan', 'expense', null, 'heart-pulse', '#34d399', 6],
            ['Dokter/RS', 'expense', 'Kesehatan', 'hospital', '#34d399', 1],
            ['Obat-obatan', 'expense', 'Kesehatan', 'pill', '#34d399', 2],
            ['Vitamin/Suplemen', 'expense', 'Kesehatan', 'activity', '#34d399', 3],
            ['BPJS', 'expense', 'Kesehatan', 'landmark', '#34d399', 4],
            ['Gym/Fitness', 'expense', 'Kesehatan', 'dumbbell', '#34d399', 5],

            // Hiburan
            ['Hiburan', 'expense', null, 'party-popper', '#a78bfa', 7],
            ['Film/Bioskop', 'expense', 'Hiburan', 'film', '#a78bfa', 1],
            ['Streaming', 'expense', 'Hiburan', 'tv', '#a78bfa', 2],
            ['Game', 'expense', 'Hiburan', 'gamepad-2', '#a78bfa', 3],
            ['Liburan/Wisata', 'expense', 'Hiburan', 'plane', '#a78bfa', 4],
            ['Hobi', 'expense', 'Hiburan', 'palette', '#a78bfa', 5],

            // Pakaian
            ['Pakaian', 'expense', null, 'shirt', '#fb923c', 8],
            ...
            ['Sedekah/Donasi', 'expense', 'Lainnya', 'heart-handshake', '#94a3b8', 1],
            ['Hadiah', 'expense', 'Lainnya', 'gift', '#94a3b8', 2],
